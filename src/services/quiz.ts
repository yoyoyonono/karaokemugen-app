...
import { defineOldSongname } from '../lib/services/karaCreation.js';
...
export async function stopAcceptingAnswers() {
	...
	const song = { ...gameState.currentSong };
	const songString = (await defineOldSongname(formatKaraV4(song.song))).songname; //TODO use defineFilename
